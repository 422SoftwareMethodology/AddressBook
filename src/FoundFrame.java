...
public class FoundFrame extends JFrame{
	...
	public static ArrayList<Contact> foundContactList = new ArrayList<Contact>(); // list of found search items
	
	public FoundFrame(ArrayList<Contact> newContactList){  // This is the main interface of addressbook
		super("Addressbook!");
